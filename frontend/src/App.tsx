...
import { Archive, ArrowUp, Check, CheckCheck, ChevronDown, Command, FileCode2, FolderKanban, Gauge, Layers3, Menu, Mic, MoreHorizontal, Plus, RefreshCw, Search, Settings2, Sparkles, Square, SquareTerminal, SunMedium, Trash2, X } from 'lucide-react'
